...
# CUDA_VISIBLE_DEVICES=2 python -m flexllmgen.flex_qwen2 \
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True CUDA_VISIBLE_DEVICES=2 python -m flexllmgen.flex_qwen2 \
	--model $model \
